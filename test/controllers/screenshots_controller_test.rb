...
class ScreenshotsControllerTest < ActionController::TestCase
  ...
  test "should create screenshot" do
    assert_difference('Screenshot.count') do
      post :create, screenshot: { data: @screenshot.data, filename: @screenshot.filename, mime_type: @screenshot.mime_type, name: @screenshot.name }
    end
  ...
  test "should update screenshot" do
    patch :update, id: @screenshot, screenshot: { data: @screenshot.data, filename: @screenshot.filename, mime_type: @screenshot.mime_type, name: @screenshot.name }
    assert_redirected_to screenshot_path(assigns(:screenshot))
  end
